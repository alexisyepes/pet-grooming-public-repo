...
class index extends Component {
  ...
  async onSubmit(e) {
    ...
    let obj = {
      ...
      lastName: this.capitalizeFirstLetter(this.state.client.lastName).replace(
        /[^A-Z0-9]/gi,
        ""
      ),
  ...
  async updatePet(e) {
    ...
    let petObj = {
      name: this.capitalizeFirstLetter(this.state.petNameToEdit).replace(
        /[^A-Z0-9]/gi,
        ""
      ),
