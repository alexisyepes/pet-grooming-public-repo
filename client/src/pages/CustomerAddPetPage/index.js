...
class index extends Component {
  ...
  async componentDidMount() {
    await axios
      .get("/auth/customer/" + this.props.match.params.regid)
      .then(async (res) => {
        await this.setState({
  ...
  onSubmitPetForm = async (e) => {
    ...
    let obj = {
      name: this.capitalizeFirstLetter(this.state.petName).replace(
        /[^A-Z0-9]/gi,
        ""
      ),
      breed: this.capitalizeFirstLetter(this.state.breed).replace(
        /[^A-Z0-9]/gi,
        ""
      ),
  ...
  render() {
    ...
    return (
      <div className="container customer-add-pet-page-container">
                  ...
                  <form className="form-group" onSubmit={this.onSubmitPetForm}>
                    ...
                    <p className="agree-with-photo">
                      ...
                      <span className="photo-release ">
                        ...
                        authorize Amazing Pet grooming Milton, to publish
                        photographs taken of my pet(s), for use in the Company's
                        print, online and video-based marketing materials, as
                        well as other Company publications. I also understand
                        that I will not receive financial compensation of any
                        type associated with this material.
                      </span>
                    </p>
