...
class Profile extends Component {
  ...
  async componentDidMount() {
    alert(
      "This page is used by clients in the reception area, where they get registered. \nThe computer used for this page is always logged in as a customer, and the Navbar won't be visible, (It is visible only if you are logged in as an admin). \nThe only way to log out from this page is by providing the credentials from the staff members"
    );
  ...
  handleFormSubmit = async (e) => {
    ...
    await API.addClient({
      ...
      .then((res) => {
        window.location.href = "/auth/customer/" + res.data.registrationNumber;
      })
      .catch((err) => {
        this.setState({
          loadingAxiosReq: false,
                ...
                <div className="row">
                  ...
                  <div className="col-lg-8 termsAndConditions-parent">
                    ...
                    <p className="registration-paragraph text-align-justify">
                      ...
                      discretion, may engage the services of a Veterinarian at
                      ROBINSON PET HOSPITAL and any expense shall be paid by you
                      (the owner). AMAZING PET GROOMING will not be liable for
                      any accident or injury to your pet caused while using the
