      ...
      >
        ...
        >
          ...
          >
            ...
            <h5 style={styles.smallContent}>905 878-9009 / 905 878-5557</h5>
            <br></br>
            <h3 style={styles.smallContent}>
              <i
            ...
            <a href="mailto: amazingpetgroomingmilton@gmail.com">
              <h6>
                <i>amazingpetgroomingmilton@gmail.com</i>
              </h6>
            </a>
            <Link to="/schedule">
              <h4 className="text-left-home-page bottom-text-home">
                <span className="also-in-cambridge-home">
                  ...
                  <span className="learn-more-contact"> learn more...</span>
                </span>
              </h4>
            </Link>{" "}
            <div className="bookingBtnContact">
              <BookingBtn />
            </div>
          </div>
          <div className="col-md-6">
            ...
            >
              <img
                style={styles.image}
                alt="gooogle Map"
                src="https://res.cloudinary.com/bootcamp2019/image/upload/v1556559547/GoogleMap.png"
              ></img>
            </a>
          </div>
          <div className="col-md-12">
